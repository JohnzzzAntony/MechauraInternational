...
export interface ProductCategory {
  ...
  icon: string;
  image: string;
  /** Detailed application bullets shown on the product detail page */
...
export const seedProducts: ProductCategory[] = [
  ...
  },
  {
    ...
    description:
      "Our abrasive removal brushes are manufactured from premium nylon filaments impregnated with silicon carbide or aluminium oxide grit. They are designed for controlled surface finishing on metal, composite, and wood substrates — delivering consistent results without the geometrical damage associated with traditional wire brushes. Available in cup, wheel, end, and twisted-knot configurations. Mechaura International offers a complete line of abrasive brush solutions to meet all of your surface preparation and finishing requirements across a wide range of industrial applications.",
    applications: [
  ...
  },
  {
    ...
    typicalApplications: [
      ...
      "Heavy mining & earthmoving equipment",
      "Marine propulsion systems",
      "Agricultural machinery",
      "Gearboxes & reducers",
      "Machine tool spindles",
      "Pump & compressor shafts",
      "Railway & rail vehicle axles",
  ...
  },
  {
    ...
    description:
      "Our hydraulic hose portfolio covers SAE 100R1 through 100R12 standards, with working pressures up to 280 bar (4,000 PSI). Hoses are constructed with synthetic rubber inner tubes, multiple steel wire reinforcement layers, and abrasion-resistant covers. We supply pre-assembled hoses with crimped fittings to customer specification, alongside a full range of compatible fittings and adapters. Mechaura International offers a comprehensive line of hydraulic hose solutions to meet all your fluid power requirements.",
    applications: [
    ...
    typicalApplications: [
      ...
      "Agricultural & irrigation machinery",
      "Oil & gas fluid transfer lines",
      "Mining & quarrying equipment",
      "Marine & offshore hydraulics",
      "Material handling cranes & hoists",
      "Steel mill & foundry equipment",
      "Plastic injection moulding machines",
      "Forklift & reach truck systems",
      "Waste management vehicles",
      "Aerospace ground support equipment",
    ],
    subProducts: [
      "SAE 100R1 Wire Braid Hose",
      "SAE 100R2 Double Wire Braid Hose",
      "SAE 100R9 Four Spiral Wire Hose",
      "SAE 100R12 Heavy Duty Spiral Hose",
      "PTFE Hydraulic Hose",
  ...
  },
  {
    ...
    typicalApplications: [
      ...
      "Drilling & deep-hole boring",
      "Tapping & thread milling",
      "Reaming & precision boring",
      "Face milling & shoulder milling",
      "Grooving & parting operations",
      "Stainless steel & titanium machining",
      "Aluminium & non-ferrous machining",
      "Cast iron machining",
      "Hardened steel & toolsteel machining",
      "Aerospace composite trimming",
    ],
    subProducts: [
      "Indexable Carbide Inserts (CNMG/TNMG)",
      "Solid Carbide End Mills",
      "Solid Carbide Drills",
      "HSS Twist Drills",
      "Thread Taps (HSS & Carbide)",
      "Reamers & Boring Bars",
      "Indexable Milling Cutters",
      "Grooving & Parting Tools",
      "Tool Holders & Collet Chucks",
    ],
  ...
  },
  {
    ...
    description:
      "A curated range of elevator components including guide rails, door operators, buffers, ropes, and control accessories. We serve elevator OEMs, installers, and maintenance contractors across the GCC with parts that comply with EN 81 and local civil defence requirements. Custom kits are available for modernization projects and retrofits. Mechaura International offers elevator accessories and brushes compatible with all major elevator brands and systems.",
    applications: [
    ...
    typicalApplications: [
      ...
      "Service & dumbwaiter lifts",
      "Car park & vehicle lifts",
      "Home lifts & platform lifts",
      "Modernization & control upgrades",
      "Preventive maintenance contracts",
      "Emergency & safety device testing",
      "Guide rail installation & alignment",
      "Door operator replacement programs",
    ],
    subProducts: [
      "Guide Rail Brushes",
      "Door Sill Brushes",
      "Safety Gear & Buffers",
      "Elevator Ropes & Belts",
      "Door Operators & Controllers",
      "Landing Buttons & Indicators",
      "Pit Lighting & Stop Switches",
      "Governor & Overspeed Devices",
      "Counterweight Frame Accessories",
    ],
  ...
  },
  {
    ...
    description:
      "High-performance bandsaw blades engineered for cutting structural steel, solid bars, tubes, and exotic alloys. Our bi-metal blades feature M42 high-speed steel teeth electron-beam welded to a flexible alloy steel backer, delivering long life and resistance to tooth strippage. Carbide-tipped options are available for high-production cutting of difficult materials. Mechaura International offers bandsaw blades compatible with all leading machine brands and cutting applications.",
    applications: [
    ...
    typicalApplications: [
      ...
      "Non-ferrous bars (copper, aluminium)",
      "Bundle cutting operations",
      "High-production sawing cells",
      "Structural fabrication workshops",
    ],
    subProducts: [
      "Bi-Metal M42 Bandsaw Blades",
      "Carbide-Tipped Bandsaw Blades",
      "Carbon Steel Bandsaw Blades",
      "Variable Pitch Blades (VP)",
      "Positive Rake Blades",
      "Blade Welding & Coiling",
      "Blade Guides & Tensioners",
      "Coolant Brushes for Bandsaws",
    ],
