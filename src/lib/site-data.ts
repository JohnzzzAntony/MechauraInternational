/**
 * Mechaura International — Central content & data source
 * All business information, products, services, industries, and copy
 * live here so sections stay DRY and content is editable in one place.
 */
...
export const stats = [
  { value: 6, suffix: "+", label: "Years of Industrial Supply", sub: "Serving the GCC since 2019" },
  { value: 500, suffix: "+", label: "Active B2B Clients", sub: "Across manufacturing & energy" },
  { value: 1200, suffix: "+", label: "SKUs Supplied", sub: "From stock & on demand" },
  { value: 98, suffix: "%", label: "On-Time Delivery Rate", sub: "Tracked quarterly" },
];
...
export const products: ProductCategory[] = [
  {
    ...
    icon: "brush",
    image: "/products/abrasive-brush.svg",
  },
  {
    slug: "bearings",
    name: "Bearings",
  ...
  },
  {
    ...
    icon: "git-branch",
    image: "/products/hydraulic-hose.svg",
  },
  {
    slug: "cutting-tools",
    name: "Cutting Tools",
    ...
    icon: "scissors",
    image: "/products/cutting-tools.svg",
  },
  {
    ...
    icon: "move-vertical",
    image: "/products/elevator-accessories.svg",
  },
  {
    slug: "bandsaw-blades",
    name: "Bandsaw Blades",
    ...
    icon: "zap",
    image: "/products/bandsaw-blades.svg",
  },
];
